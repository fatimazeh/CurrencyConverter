            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('../lib/images/Logo.gif'), // Path to your small logo image
                  fit: BoxFit.contain,
                ),
              ),
            ),
            ...
            child: SingleChildScrollView(
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: Color(0xFFE1DED7), // Light Brown
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: const Icon(Icons.person, color: Colors.black), // Black
                        border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(15.0),
                          borderSide: const BorderSide(color: Colors.black), // Black
                        ),
                      ),
                      style: TextStyle(
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        hintText: "Password",
                        prefixIcon: Icon(Icons.lock, color: Colors.black), // Black
                        border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(15.0),
                          borderSide: const BorderSide(color: Color(0xFF95A7B1)), // Light Blue
                        ),
                      ),
                      obscureText: true,
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: const LinearGradient(
                            colors: [Color(0xFF597CFF), Colors.white], // Dark Blue to White
 ...
 Future<void> loginAdmin() async {
  try {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        backgroundColor: Color(0xFFA80C0C), // Red for errors
        content: Text(
